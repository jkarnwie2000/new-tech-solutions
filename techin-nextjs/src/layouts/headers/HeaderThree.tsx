...
const HeaderThree = () => {
  ...
  return (
    <>
      <header className={`site-header techin-header-section ${sticky ? 'sticky-menu' : ''}`} id="sticky-menu">
            ...
            <div className="techin-header-bottom">
              <div className="techin-header-main-menu bg-accent">
                ...
                <div className="header-btn header-btn-l1 d-none d-xs-inline-flex">
                  ...
                  <Link className="techin-default-btn techin-header-btn" data-text="Get A Quote" href="/contact-us">
                    <span className="button-wraper">Get A Quote</span>
                  </Link>
                </div>
                <button className="techin-menu-toggle d-inline-block d-xl-none dark-color" onClick={() => setOpenMenu(true)}>
                  <span></span>
                </button>
              </div>
            </div>
