...
const HeaderTwo = () => {
  ...
  return (
    <>
      <header className={`site-header techin-header-section techin-header-two ${sticky ? 'sticky-menu' : ''}`} id="sticky-menu">
        <div className="techin-header-wrapper2">
          ...
          <div className="techin-header-right">
            <div className="techin-header-wrap2">
              <div className="techin-header-top2">
                <div className="techin-header-info">
                  <ul>
                    <li>
                      <a href="tel:123"><img src="assets/images/blog/phone.svg" alt="phone logo" /> (+999) 123 98765</a>
                    </li>
                    <li>
                      <a href="mailto:name@email.com"><img src="assets/images/blog/gmail.svg" alt="gmail logo" /> info@techin.com</a>
                    </li>
                    <li>
                      <a href="mailto:name@email.com"><img src="assets/images/blog/gmail.svg" alt="gmail logo" /> Mon-Fri: 10:00Am-09:00Pm</a>
                    </li>
                  </ul>
                </div>
            ...
            <div className="techin-header-bottom2 dark-bg2">
              <div className="techin-header-wrap2">
                <div className="techin-header-main-menu menu2">
                  ...
                  <div className="header-btn header-btn-l1 d-none d-xs-inline-flex">
                    <div className="techin-header-icon">
                      <div className="techin-header-search" onClick={() => setSearchOpen(true)}>
                        <img src="assets/images/blog/2.svg" alt="" />
                      </div>
                      <div className="techin-header-triger triger2" onClick={() => setOpen(true)}>
                        <img src="assets/images/blog/1.svg" alt="" />
                      </div>
                    </div>
                    <Link className="techin-default-btn techin-header-btn" href="/conact-u">Get A Quote</Link>
                  </div>

                  <button className="techin-menu-toggle d-inline-block d-xl-none" onClick={() => setOpenMenu(true)}>
                    <span></span>
                  </button>
                </div>
              </div>
