...
const FooterTwo = () => {
  return (
    <>
      <footer className="techin-footer-section" style={{ backgroundImage: 'url(/assets/images/footer/footer-bg1.png)' }}>
          ...
          <div className="techin-footer-top">
            <div className="row">
              <div className="col-xl-4 col-lg-12">
                <div className="techin-footer-textarea light-color">
                  ...
                  <form className="subscribe-form" onSubmit={(e) => e.preventDefault()}>
                    ...
                    <button type="submit"><img src="assets/images/footer/plane.svg" alt="" />Subscribe</button>
                  </form>
                </div>
              </div>
              ...
              <div className="col-xl-3 col-md-6">
                <div className="techin-footer-menu mb-0">
                  <div className="techin-footer-title">
                    <h5>Recent Post</h5>
                  </div>
                  <div className="recent-post footer-blog">
                    ...
                    <div className="media-body">
                      <div className="recent-post-meta">
                        <div className="post-title">
                          <Link className="text-inherit" href="/single-blog">Global Business Goal Make Life Easy From Tech</Link>
                        </div>
                        <Link href="/blog">
                          <img src="assets/images/blog/6.svg" alt="" /><span>24 Feb, 2022</span></Link>
                      </div>
                    </div>
                  </div>
                  <div className="recent-post footer-blog">
                    ...
                    <div className="media-body">
                      <div className="recent-post-meta">
                        ...
                        <Link href="/blog"><img src="assets/images/blog/6.svg" alt="" /><span>24 Feb, 2022</span></Link>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="techin-footer-info">
          <div className="container">
            <div className="techin-footer-info-wraper">
              <div className="techin-footer-info-item">
                ...
                <div className="techin-footer-info-text">
                  <ul>
                    <li>
                      <a href="mailto:name@gmail.com">
              ...
              <div className="techin-footer-info-item">
                <div className="techin-footer-info-icon">
                  <a href="mailto:name@gmail.com"><img src="assets/images/footer/gmail.svg" alt="" /></a>
                </div>
                <div className="techin-footer-info-text">
                  <ul>
                    <li>
              ...
              <div className="techin-footer-info-item">
                <div className="techin-footer-info-icon">
                  <a href="tel:009"><img src="assets/images/footer/phone.svg" alt="" /></a>
                </div>
                <div className="techin-footer-info-text">
                  <ul>
                    <li>
