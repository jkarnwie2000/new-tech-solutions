...
const FooterOne = () => {
  return (
    <>
      <footer className="techin-footer-section1 section" style={{ backgroundImage: 'url(/assets/images/v1/pricing-bg.png)' }}>
        <div className="container">
          <div className="techin-footer-top">
            <div className="row">
              <div className="col-xl-4 col-lg-12">
                <div className="techin-footer-textarea footer1">
                  <Link href="/">
                    <img src="assets/images/logo/logo-white.svg" alt="" />
                  </Link>
                  <p>At Techin, we deliver innovative IT solutions to help businesses thrive, offering customized strategies, robust support, and cutting-edge technology for efficiency, security, and reliability.</p>
                  <form className="subscribe-form" onSubmit={(e) => e.preventDefault()}>
                    <input type="email" placeholder="Your Email Address" />
                    <button className="button2" type="submit"><img src="assets/images/footer/plane.svg" alt="" />Subscribe</button>
                  </form>
                </div>
              </div>
              <div className="col-xl-2 col-md-4">
                <div className="techin-footer-menu ml-60">
                  <div className="techin-footer-title footer-one">
                    <h5>Quick Links</h5>
                  </div>
                  <ul>
                    <li>
              ...
              <div className="col-xl-2 col-md-4">
                <div className="techin-footer-menu ml-35">
                  <div className="techin-footer-title footer-one">
                    <h5>Explore</h5>
                  </div>
                  <ul>
              ...
              <div className="col-xl-4 col-md-4">
                <div className="techin-footer-menu2 ml-60">
                  <div className="techin-footer-title footer-one">
                    <h5>Instagram</h5>
                  </div>
                  <div className="techin-instagram-wrap">
                    <div className="techin-instagram-thumb">
                      <Link href="/portfolio"><img src="assets/images/footer/f1.png" alt="" /></Link>
                    </div>
                    <div className="techin-instagram-thumb">
                      <Link href="/portfolio"><img src="assets/images/footer/f4.png" alt="" /></Link>
                    </div>
                    <div className="techin-instagram-thumb">
                      <Link href="/portfolio"><img src="assets/images/footer/f2.png" alt="" /></Link>
                    </div>
                    <div className="techin-instagram-thumb">
                      <Link href="/portfolio"><img src="assets/images/footer/f5.png" alt="" /></Link>
                    </div>
                    <div className="techin-instagram-thumb">
                      <Link href="/portfolio"><img src="assets/images/footer/f6.png" alt="" /></Link>
                    </div>
                    <div className="techin-instagram-thumb">
                      <Link href="/portfolio"><img src="assets/images/footer/f3.png" alt="" /></Link>
                    </div>
                  </div>
                  <ul>
                    <li>
          ...
          <div className="techin-footer-info2">
            <div className="techin-footer-info-wraper">
              <div className="techin-footer-info-item">
                <div className="techin-footer-info-icon">
                  <img src="assets/images/footer/icon1.svg" alt="" />
                </div>
                <div className="techin-footer-info-text info1">
          ...
          <div className="techin-footer-bottom bottom2">
            <div className="techin-copywright">
              <p>Copyright &copy; <span id="current-year"></span> <span className="footer-text">techin</span>. All rights reserved by <span className="footer-text"> favdevs.</span></p>
            </div>
