...
const FooterThree = () => {
  return (
    <>
      <footer className="techin-footer-section3 section" style={{ backgroundImage: 'url(/assets/images/footer/footer-bg3.png)' }}>
        <div className="container">
                  ...
                  <div className="recent-post footer-blog">
                    ...
                    <div className="media-body">
                      <div className="recent-post-meta">
                        ...
                        <Link href="/blog"><img src="assets/images/blog/6.svg" alt="" />
                          <span>24 Feb, 2022</span>
                        </Link>
                      </div>
                    </div>
          ...
          <div className="techin-footer-bottom bottom2">
            <div className="techin-copywright">
              <p>Copyright &copy; {new Date().getFullYear()} <span className="footer-text">techin</span>. All rights reserved by <span className="footer-text"> favdevs.</span></p>
            </div>
