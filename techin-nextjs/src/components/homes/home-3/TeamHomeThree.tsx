        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-xl-3 col-md-6">
              <div className="techin-team-wrap3">
                <div className="techin-team-thumb3">
                  <img src="assets/images/v3/t1.png" alt="" />
                </div>
                <div className="techin-team-content3">
                  <Link href="/single-team">
                    <h5>Sophia Reynolds</h5>
                  </Link>
                  <p>Head of IT Operations</p>
                  <div className="techin-team-social3">
                    <ul>
                      <li>
            ...
            <div className="col-xl-3 col-md-6">
              <div className="techin-team-wrap3">
                <div className="techin-team-thumb3">
                  <img src="assets/images/v3/t2.png" alt="" />
                </div>
                <div className="techin-team-content3">
                  <Link href="/single-team">
                    <h5>Alex Smith</h5>
            ...
            <div className="col-xl-3 col-md-6">
              <div className="techin-team-wrap3">
                <div className="techin-team-thumb3">
                  <img src="assets/images/v3/t3.png" alt="" />
                </div>
                <div className="techin-team-content3">
                  <Link href="/single-team">
            ...
            <div className="col-xl-3 col-md-6">
              <div className="techin-team-wrap3">
                <div className="techin-team-thumb3">
                  <img src="assets/images/v3/t4.png" alt="" />
                </div>
                <div className="techin-team-content3">
                  <Link href="/single-team">
                    <h5>Emily Carter</h5>
