            ...
            <div className="col-xl-4 col-md-6">
              <div className="blog-wrapper3">
                <div className="blog-content3">
                  ...
                  <h5 className="blog-title2"><Link href="/single-blog">How IT Infrastructure Can Improve Efficiency and Productivity</Link></h5>
                </div>
                <div className="blog-img">
            ...
            <div className="col-xl-4 col-md-6">
              <div className="blog-wrapper3">
                <div className="blog-content3">
                  ...
                  <h5 className="blog-title2"><Link href="/single-blog">How to Ensure Seamless IT Integration Across Departments</Link></h5>
                </div>
                <div className="blog-img">
