...
const NextArrow = (props: any) => {
  const { onClick } = props;
  return <button className="slide-arrow techin-p-slider-next" onClick={onClick}></button>;
};

const PrevArrow = (props: any) => {
  const { onClick } = props;
  return <button className="slide-arrow techin-p-slider-prev" onClick={onClick}></button>;
};
    ...
    <>
      <section className="techin-section-padding6">
        <div className="container">
          ...
          <Slider {...settings} className="techin-three-column">
            <div className="techin-t-wrap2">
              <div className="techin-t-thumb">
                <img src="assets/images/v2/img10.png" alt="" />
              </div>
              ...
              <div className="techin-t-author-wrap">
                <div className="techin-t-author-content">
                  <h6>Laura McAlister</h6>
                  <p>Tech Startup Founder</p>
                </div>
                <div className="techin-t-author-icon">
                  <img src="assets/images/v2/quote.svg" alt="" />
                </div>
              </div>
            </div>
            <div className="techin-t-wrap2">
              <div className="techin-t-thumb">
                <img src="assets/images/v2/img11.png" alt="" />
              </div>
              <div className="techin-pricing-shape shape-show">
                <img src="assets/images/v1/shape-show.png" alt="" />
              </div>
              ...
              <div className="techin-t-text">
                <p>““Thanks to TechIN, our company has seen a major improvement in network performance and security. They truly understand our business needs and deliver beyond expectations.”</p>
              </div>
              <div className="techin-t-author-wrap">
                <div className="techin-t-author-content">
                  <h6>Michael Parker</h6>
                  <p>Tech Startup Founder</p>
                </div>
                <div className="techin-t-author-icon">
                  <img src="assets/images/v2/quote.svg" alt="" />
            ...
            <div className="techin-t-wrap2">
              <div className="techin-t-thumb">
                <img src="assets/images/v2/img12.png" alt="" />
              </div>
              <div className="techin-pricing-shape shape-show">
                <img src="assets/images/v1/shape-show.png" alt="" />
              </div>
              ...
              <div className="techin-t-author-wrap">
                <div className="techin-t-author-content">
                  <h6>James Rabishaw</h6>
                  <p>Financial Services Executive</p>
                </div>
                <div className="techin-t-author-icon">
                  <img src="assets/images/v2/quote.svg" alt="" />
                </div>
      ...
      <div className="container">
        <div className="techin-brand-wrap2">
          ...
          <Slider {...settings2} className="techin-brand-slider2 brand-no-arrow">
