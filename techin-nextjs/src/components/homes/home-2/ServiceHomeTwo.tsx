...
const ServiceHomeTwo = () => {
  ...
  return (
    <>
      <div className="techin-section-padding4 section" style={{ backgroundImage: 'url(/assets/images/v2/Services.png)' }}>
        <div className="container">
          <div className="techin-section-title version2">
            <div className="row">
      ...
      <div className="techin-service-wraper2">
        <div className="container">
          <Slider {...settings} className="techin-three-column2">
            <div className="techin-service-wrap2">
              ...
              <div className="techin-service-content2">
                ...
                <Link className="techin-default-btn techin-service-btn" data-text="Read More" href="/about-us">
