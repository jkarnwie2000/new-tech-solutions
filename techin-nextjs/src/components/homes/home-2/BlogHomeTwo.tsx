            ...
            <div className="col-xl-4 col-md-6">
              <div className="blog-wrap2">
                <div className="blog-thumb2">
                  <img src="assets/images/v2/b1.png" alt="" />
                  <Link className="techin-default-btn blog-btn2" href="/single-blog" data-text="Read More">
                ...
                <div className="blog-content2">
                  ...
                  <h5 className="blog-title title2"><Link href="/single-blog">How to Optimize Your IT Infrastructure for Maximum Efficiency</Link></h5>
                </div>
              </div>
            </div>
            <div className="col-xl-4 col-md-6">
              <div className="blog-wrap2">
                <div className="blog-thumb2">
                  <img src="assets/images/v2/b2.png" alt="" />
                  <Link className="techin-default-btn blog-btn2" href="/single-blog" data-text="Read More">
                    <span className="button-wraper">Read More</span>
                  </Link>
                  <div className="blog-date">
                ...
                <div className="blog-content2">
                  ...
                  <h5 className="blog-title title2"><Link href="/single-blog">How IT Infrastructure Can Improve Efficiency and Productivity</Link></h5>
                </div>
              </div>
            </div>
            <div className="col-xl-4 col-md-6">
              <div className="blog-wrap2">
                <div className="blog-thumb2">
                  <img src="assets/images/v2/b3.png" alt="" />
                  <Link className="techin-default-btn blog-btn2" href="/single-blog" data-text="Read More">
                    <span className="button-wraper">Read More</span>
                  </Link>
                  <div className="blog-date">
                ...
                <div className="blog-content2">
                  ...
                  <h5 className="blog-title title2"><Link href="/single-blog">How to Ensure Seamless IT Integration Across Departments</Link></h5>
                </div>
              </div>
            </div>
          </div>
