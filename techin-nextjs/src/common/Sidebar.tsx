...
const Sidebar = ({setOpen, open} : SidebarProps) => {
  return (
    <>
      <div className="techin-sidemenu-wraper">
        <div className={`techin-sidemenu-column ${open ? "active" : ""}`}>
          <div className="techin-sidemenu-body">
            <div className="techin-sidemenu-logo">
              <Link href="/">
            ...
            <div className="techin-sidemenu-thumb">
              <img src="assets/images/blog/img15.png" alt="" />
            </div>
            <div className="techin-contact-info-wrap">
              <div className="techin-contact-info">
            ...
            <span className="techin-sidemenu-close" onClick={() => setOpen(false)}>
              <i className="ri-close-line"></i>
            </span>
          </div>
        </div>
        <div className={`offcanvas-overlay ${open ? "active" : ""}`} onClick={() => setOpen(false)}></div>
        <div className="offcanves-menu"></div>
      </div>
    </>
  );
};
